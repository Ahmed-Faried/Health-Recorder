      ...
      child: BlocConsumer<ForgetPassDoctor, ForgetPassDoctorStates>(
        listener: (context, state) {
          ...
          if (state is ForgetPassDoctorErrorStates) {
            toastShow(
                msg: "incorrect email or Phone Number  ",
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "E-mail ",
                          style: TextStyle(
                              fontSize: 18, fontFamily: 'MontaguSlab'),
                        ),
                        TextFormField(
                          ...
                          children: [
                            Container(
                              ...
                              child: Center(
                                  child: InkWell(
                                      onTap: () {
                                        ForgetPassDoctor.get(context)
                                            .ForgetPassDoctorFunction(
                                          email: ForgetPassDoctor.get(context)
                                              .email
                                              .text,
                                          phoneNumber:
                                              ForgetPassDoctor.get(context)
