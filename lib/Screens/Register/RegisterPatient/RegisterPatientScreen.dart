                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: PhysicalModel(
                                    ...
                                    child: TextFormField(
                                      controller:  RegisterCubit.get(context).firstNamePatientController,
                                ...
                                Expanded(
                                  ...
                                  child: PhysicalModel(
                                    ...
                                    shadowColor: Colors.grey,
                                    child: TextFormField(
                                      controller: RegisterCubit.get(context).lastNamePatientController,
                                      keyboardType: TextInputType.text,
                                      onTap: () {},
                                      onChanged: (vaule) {},
                                      validator: (vaule) {
                          ...
                          FieldFromRegistr(
                            controller: RegisterCubit.get(context).emailPatientController,
                          ...
                          FieldFromRegistr(
                            controller: RegisterCubit.get(context).passwordPatientController,
                            ...
                            suffix: IconButton(
                              ...
                              icon: Icon(RegisterCubit.get(context).showPassword),
                            ),
                            obscureText:
                          ...
                          FieldFromRegistr(
                            controller: RegisterCubit.get(context).numberPatientController,
                          ...
                          FieldFromRegistr(
                            controller: RegisterCubit.get(context).agePatientController,
                          ...
                          FieldFromRegistr(
                            controller: RegisterCubit.get(context).nationalIDPatientController,
                            type: TextInputType.phone,
                            onSubmit: () {},
                            onChanged: () {},
                            onTap: () {},
                          ...
                          FieldFromRegistr(
                            controller: RegisterCubit.get(context).genderPatientController,
                          ...
                          FieldFromRegistr(
                            controller: RegisterCubit.get(context).bloodTypePatientController,
                            type: TextInputType.text,
                            onSubmit: () {},
                            onChanged: () {},
                            onTap: () {},
                                      ...
                                      if (formKey1.currentState!.validate()) {
                                        try {
                                          RegisterCubit.get(context).PatientRegister(
                                            fristName:   RegisterCubit.get(context).firstNamePatientController.text,
                                            ...
                                            age: RegisterCubit.get(context).agePatientController.text,
                                          );
                                          // RegisterCubit.get(context).PatientRegister(
                                          //   fristName: 'John',
                                          //   lastName: 'Doe',
