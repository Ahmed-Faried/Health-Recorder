                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          FieldFromRegistr(
                            controller:
                                RegisterCubit.get(context).passwordDoctorController,
                            ...
                            suffix: IconButton(
                              ...
                              icon:
                                  Icon(RegisterCubit.get(context).showPassword),
                            ),
                          ...
                          FieldFromRegistr(
                            controller:
                                RegisterCubit.get(context).emailDoctorController,
                          ...
                          FieldFromRegistr(
                            controller:
                                RegisterCubit.get(context).departDoctorController,
                          ...
                          FieldFromRegistr(
                            controller:
                                RegisterCubit.get(context).addressDoctorController,
                          ...
                          FieldFromRegistr(
                            controller:
                                RegisterCubit.get(context).numberDoctorController,
                                    ...
                                    onTap: () {
                                      if (formKey.currentState!.validate()) {
                                        ...
                                        RegisterCubit.get(context).DoctorRegister(
                                                ...
                                                firstName:
                                                    RegisterCubit.get(context).firstNameDoctorController.text,
                                                lastName:
                                                    RegisterCubit.get(context)
                                                        .lastNameDoctorController
                                                        .text,
