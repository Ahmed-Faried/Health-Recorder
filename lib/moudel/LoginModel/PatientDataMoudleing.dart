...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    pationt =
        json["pationt"] == null ? null : Pationt.fromJson(json["pationt"]);
  }
}
...
class Pationt {
  ...
  Pationt.fromJson(Map<String, dynamic> json) {
    ...
    chronicDiseases = json["chronic_Diseases"] == null
        ? []
        : List<HealthProblem>.from(
            json["chronic_Diseases"]!.map((x) => HealthProblem.fromJson(x)));
    healthProblems = json["Health_problems"] == null
        ? []
        : List<HealthProblem>.from(
            json["Health_problems"]!.map((x) => HealthProblem.fromJson(x)));
    hereditaryDiseases = json["Hereditary_diseases"] == null
        ? []
        : List<HealthProblem>.from(
            json["Hereditary_diseases"]!.map((x) => HealthProblem.fromJson(x)));
    surgicalOperations = json["Surgical_operations"] == null
        ? []
        : List<SurgicalOperation>.from(json["Surgical_operations"]!
            .map((x) => SurgicalOperation.fromJson(x)));
    diagonas = json["diagonas"] == null
        ? []
        : List<Diagonas>.from(
            json["diagonas"]!.map((x) => Diagonas.fromJson(x)));
    x_ray = json["x_ray"] == null
        ? []
        : List<dynamic>.from(json["x_ray"]!.map((x) => x));
  }
}
